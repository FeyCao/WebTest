...
var MatchViewLayer = cc.Layer.extend({
    ...
    setAiBattleView:function(){
        ...
        if(this.AiBattleView ==null){
            ...
            dayCount1Btn.setPosition(cc.p(bgSize.width/6+spaceX*1,bgSize.height/2+spaceY));
            ...
            dayCount2Btn.setPosition(cc.p(bgSize.width/6+spaceX*2,bgSize.height/2+spaceY));
            ...
            dayCount3Btn.setPosition(cc.p(bgSize.width/6+spaceX*3,bgSize.height/2+spaceY));
            ...
            dayCount4Btn.setPosition(cc.p(bgSize.width/6+spaceX*4,bgSize.height/2+spaceY));
            ...
            AiMode1Btn.setPosition(cc.p(bgSize.width/6+spaceX*1,bgSize.height/2-posD));
            ...
            AiMode2Btn.setPosition(cc.p(bgSize.width/6+spaceX*2,bgSize.height/2-posD));
            ...
            AiMode3Btn.setPosition(cc.p(bgSize.width/6+spaceX*3,bgSize.height/2-posD));
            ...
            AiMode4Btn.setPosition(cc.p(bgSize.width/6+spaceX*4,bgSize.height/2-posD));
            ...
            AiMode5Btn.setPosition(cc.p(bgSize.width/6+spaceX*5,bgSize.height/2-posD));
            AiMode5Btn.setTag(104);
            mu.addChild(AiMode5Btn);


            dayCountSelect = cc.Sprite.create("res/select_bg.png");
            // dayCountSelect.setScale(1.1);
